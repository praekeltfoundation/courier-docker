...
RUN set -ex; \
  ...
  rm -rf /var/lib/apt/lists/*; \
  \
  wget -H "Authorization: Bearer $GITHUB_ACCESS_TOKEN" -O courier.tar.gz "https://github.com/$COURIER_REPO/releases/download/v${COURIER_VERSION}/courier_${COURIER_VERSION}_linux_amd64.tar.gz"; \
